...
set :scm, :git
set :repository,  "git@github.com:hjhart/urban_spoon.git"
set :branch, 'master'
...
namespace :deploy do
  ...
  task :link_shared_files, :roles => :app do
    run "ln -s #{shared_path}/db/urban_spoon.sqlite.db #{release_path}/db/urban_spoon.sqlite.db"
  end
